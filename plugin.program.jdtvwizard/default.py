...
base='JDTV Wizard'
ADDON=xbmcaddon.Addon(id='plugin.program.jdtvwizard')
...
EXCLUDES     = ['plugin.program.jdtvwizard']
HOME         =  xbmc.translatePath('special://home/')

    
def CATEGORIES():
    link = OPEN_URL('https://www.dropbox.com/s/ybpllwbddelg655/wizard.txt?dl=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("JDTV Wizard","Wizard is Whizzing down your Wires ",'', 'Put the kettle on')
    ...
    time.sleep(2)
    dp.update(0,"", "Extracting JDTV now, Please Wait")
    print '======================================='
    print addonfolder
    print '======================================='
...
def addDir(name,url,mode,iconimage,fanart,description):
        ...
        ok=True
        liz=xbmcgui.ListItem(name, iconImage="https://www.dropbox.com/s/dk23t7srrt9t00z/783e810bbc528fc6027238e507ae4a_icon.png?dl=1", thumbnailImage=iconimage)
...
def FRESHSTART(params):
    ...
    choice2 = xbmcgui.Dialog().yesno("Are you sure?", 'Are you sure you want to wipe this install?', '', 'All addons EXCLUDING JDTV WIZARD will be completely wiped!', yeslabel='Yes',nolabel='No')
    if choice2 == 0:
        return
    elif choice2 == 1:
